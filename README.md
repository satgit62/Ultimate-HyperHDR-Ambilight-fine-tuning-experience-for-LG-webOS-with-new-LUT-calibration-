...
Note: The NV12 must be activated in config.json from `/media/developer/apps/usr/palm/services/org.webosbrew.piccap.service/` by inserting the "nv12":true followed by a (,) to the next option and saving it.
